...
const STEPS = [
  ...
  "Analyzing developer profile and contributor pool...",
  "Running metrics scoring models...",
  "Generating rule-based findings and recommendations...",
        ...
        {data && !loading && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 flex flex-col gap-6">
              ...
              {data.languages && <LanguagesChart languages={data.languages} />}
            </div>
